...
export default function Home() {
      ...
      <div class="main">
        <div class="container">
          ...
          <section id="home" style="display: flex; align-items: center;">
            <img src="/*front image source*/" alt="Front display" style="max-width: 60%; height: auto; object-fit: cover;" />
            <div>
          ...
          <section id="about">
            ...
            <div style="display: flex; align-items: center;">
              <p style="flex: 1;">Summary</p>
              <img src="/*front image source*/" alt="About image" style="max-width: 60%; height: auto; object-fit: cover;" />
            </div>
          </section>
          ...
          <section id="contactus">
            <h4>Add a Comment</h4>
            <input type="text" id="username" placeholder="Name eg. John Doe">
            <input type="text" id="projectName" placeholder="Project Name">
            <textarea id="commentText" rows="4" placeholder="Add a comment"></textarea>
            <input type="file" id="commentImage">
            <button onclick="handleCommentSubmit()">Submit</button>
            <ul id="commentList" style="list-style-type: none; padding: 0; margin-top: 20px;"></ul>
          </section>
        </div>
        ...
        <script>
          function handleCommentSubmit() {
            ...
            const imageURL = commentImage ? URL.createObjectURL(commentImage) : null;
          ...
          function renderComments() {
            ...
            comments.forEach(comment => {
              ...
              li.innerHTML = \`
                <p><strong>\${comment.username}</strong> - \${comment.projectName}</p>
                <p>\${comment.text}</p>
                \${comment.image ? \`<img src="\${comment.image}" alt="comment image" class="commentImage" style="max-width: 100px; max-height: 100px; margin-left: 10px;">\` : ''}
              \`;
            ...
            {comments.map((comment, index) => (
              <ListItem key={index}>
                <ListItemText 
                  ...
                  secondary={`${comment.username} - ${comment.projectName}`} 
                  style={{ color: themes[theme][colorIndex].text }} 
                />
                {comment.image && <img src={comment.image} alt="comment" style={{ maxWidth: '100px', maxHeight: '100px', marginLeft: '10px' }} />}
              </ListItem>
            ))}
          </List>
            </Box>
 ...
 <Card style={{ backgroundColor: themes[theme][colorIndex].background, color: themes[theme][colorIndex].text }}>
        <Box id="contactus" style={{ display: 'block', alignItems: 'center', backgroundColor: themes[theme][colorIndex].background, padding: '2%' }}>
          <Typography variant="h4" style={{ color: themes[theme][colorIndex].text }}>Add a Comment</Typography>
          <br />
          <TextField
            label="Name eg. John Doe"
            variant="outlined"
            value={username}
          ...
          <Button
            variant="outlined"
            component="label"
            style={{ color: themes[theme][colorIndex].text, borderColor: themes[theme][colorIndex].text }}
          >
            Upload Image
